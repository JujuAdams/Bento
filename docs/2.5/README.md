...
Bento supports all GameMaker export platforms, with the exception of HTML5. Bento supports GameMaker 2024.14 (and probably LTS 2026). If you'd like to report a bug or suggest a feature, please use the repo's [Issues page](https://github.com/JujuAdams/Bento/issues). Bento is constantly being maintained and upgraded; bugs are usually addressed within a few days of being reported.
