...
var _filled = (BentoRefGet(reference) == value);
...
if (_filled)
{
    draw_sprite_stretched_ext(sBentoExFrameFill, 0, bentoLeft + _offset, bentoTop + _offset, bentoHeight, bentoHeight, image_blend, image_alpha);
}
