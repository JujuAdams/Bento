...
//Change our colour when our tab is open
var _color = tabOpen? BENTO_EXAMPLE_RED : image_blend;
...
draw_sprite_ext(sprite_index, image_index, x + _offset, y + _offset, image_xscale, image_yscale, image_angle, _color, image_alpha);
