    ...
    else
    {
        ...
        if (_remaining > 0)
        {
            ...
            repeat(_childCount)
            {
                ...
                if (_child.__gui.__layoutHeightResize == GUI_RESIZE_GROW)
                {
            ...
            while (_remaining > 0)
            {
                ...
                repeat(array_length(_modifiableArray))
                {
                    ...
                    var _childSize = _child.__gui.__solvedHeight;
                    if (_childSize < _min)
                    {
                        _secondMin = _min;
                        _min = _childSize;
                ...
                repeat(_workCount)
                {
                    ...
                    var _prevSize = _child.__gui.__solvedHeight;
                    if (_prevSize == _min)
                    {
                        ...
                        _child.__gui.__solvedHeight = _newSize;
        ...
        else if (_remaining < 0)
        {
            ...
            {
                var _child = _childArray[_i];
                if (_child.__gui.__layoutHeightResize != GUI_RESIZE_STATIC)
                {
                    array_push(_modifiableArray, _child);
                }
